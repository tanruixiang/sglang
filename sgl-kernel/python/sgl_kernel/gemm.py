...
def sgl_silu_and_mul_per_token_group_quant_fp8(
    input: torch.Tensor,
    output_q: torch.Tensor,
    output_s: torch.Tensor,
    group_size: int,
    ...
    torch.ops.sgl_kernel.sgl_silu_and_mul_per_token_group_quant_fp8.default(input, output_q, output_s, group_size, eps, int8_min, int8_max)
